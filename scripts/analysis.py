...
def plots(c="Blues"):
    ...
    ax1[0].axvline(x=p[1]+np.sqrt(V[1][1]), ymin=-1, ymax=1, color='purple', alpha=0.3)
    ax1[0].axvline(x=p[1]-np.sqrt(V[1][1]), ymin=-1, ymax=1, color='purple', alpha=0.3)
    ...
    ax[0].axvline(x=p[1]+np.sqrt(V[1][1]), ymin=-1, ymax=1, color='purple', alpha=0.3)
    ax[0].axvline(x=p[1]-np.sqrt(V[1][1]), ymin=-1, ymax=1, color='purple', alpha=0.3)
    ax[0].legend()
    ...
    ax[1].axvline(x=p[1]+np.sqrt(V[1][1]), ymin=-1, ymax=1, color='purple', alpha=0.3)
    ax[1].axvline(x=p[1]-np.sqrt(V[1][1]), ymin=-1, ymax=1, color='purple', alpha=0.3)
